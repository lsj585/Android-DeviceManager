...
public class DeviceLockImpl_IsLock implements IDeviceLock_IsLock {
    ...
    public boolean isOpen(@NonNull Context context) {
        ...
        try {
            ...
            return (manager.isBackButtonDisabled(componentName) &&
                    manager.isHomeButtonDisabled(componentName) &&
                    manager.isShutdownMenuDisable(componentName) &&
                    manager.isPowerDisabled(componentName) &&
                    manager.isVolumeAdjustDisabled(componentName) &&
                    manager.isVoiceOutgoingDisabled(componentName));
