...
public class SecurityManagerImpl_DisallowRun extends BaseManager implements ISecurityManager_DisallowRun{

    public SecurityManagerImpl_DisallowRun(@NonNull DevicePolicyManager devicePolicyManager, @NonNull ComponentName componentName) {
        super(devicePolicyManager, componentName);
    }

    public SecurityManagerImpl_DisallowRun(@NonNull DevicePolicyManager devicePolicyManager) {
