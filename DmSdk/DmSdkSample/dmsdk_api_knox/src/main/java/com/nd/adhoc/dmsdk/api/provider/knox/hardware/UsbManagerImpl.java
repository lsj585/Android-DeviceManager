...
public class UsbManagerImpl extends BaseManager implements IUsbMamager {

    public UsbManagerImpl(@NonNull DevicePolicyManager devicePolicyManager, @NonNull ComponentName componentName) {
        super(devicePolicyManager, componentName);
    }

    public UsbManagerImpl(@NonNull DevicePolicyManager devicePolicyManager) {
